...
int main() {
    ...
    cout << endl << "ћассив без изменений: " << endl;
    FillArray(arr, size);
    ShowArray(arr, size);


    cout << "¬ведите „исло что бы добавить в конец массива: " << endl;
    cin >> number;
    PushBack(arr, size, number);
    ShowArray(arr, size);


    cout << "¬ведите „исло что бы добавить в начало массива: " << endl;
    cin >> number;
    PushForward(arr, size, number);
    ShowArray(arr, size);


    cout << "¬ведите индекс масива что бы заменить число: " << endl;
    cin >> index;
    cout << "¬ведите „исло: " << endl;
    cin >> number;
    AnyNumber1(arr, size, number, index);
    ShowArray(arr, size);

    cout << "¬ведите индекс масива что бы добавить число: " << endl;
    cin >> index;
    cout << "¬ведите „исло: " << endl;
    cin >> number;
    ...
    cout << "¬ведите индекс масива что бы удалить число: " << endl;
    cin >> index;
